...
with(power_sub, plot(newDateTime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
...
with(power_sub, plot(newDateTime, Global_reactive_power, type = "l", xlab="datetime", ylab="Global_reactive_power"))
